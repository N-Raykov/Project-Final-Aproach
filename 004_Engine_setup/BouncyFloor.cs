...
public class BouncyFloor : EasyDraw
{
    public Vec2 start;
    public Vec2 end;
    Vec2 rotationOrigin;
    ...
    public BouncyFloor(Vec2 pStart, Vec2 pEnd, bool pIsRotating = false) : base(2000, 2000)//its 1500 1500 just to make sure it works for the rotating lines
    {
